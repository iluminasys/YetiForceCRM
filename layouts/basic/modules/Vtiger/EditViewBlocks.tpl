				...
				<div class="col-md-4">
					<div class="contentHeader">
						...
						<span class="pull-right">
							<button class="btn btn-success" type="submit" title="{\App\Language::translate('LBL_SAVE', $QUALIFIED_MODULE_NAME)}"><strong><span class="glyphicon glyphicon-ok"></span></strong></button>&nbsp;&nbsp;
							<button class="btn btn-warning" type="reset" onclick="javascript:window.history.back();" title="{\App\Language::translate('LBL_CANCEL', $QUALIFIED_MODULE_NAME)}"><strong><span class="glyphicon glyphicon-remove"></span></strong></button>
						</span>
						<span class="pull-right">
